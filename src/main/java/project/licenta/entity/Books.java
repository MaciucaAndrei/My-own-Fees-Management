...
public class Books {
    ...
    public Calendar getLoan_date() {return loan_date;}
    public void setLoan_date(Calendar loan_date) {this.loan_date = loan_date;}
    public Calendar getDate_of_return() {return date_of_return;}
    public void setDate_of_return(Calendar date_of_return) {this.date_of_return = date_of_return;}
    @Override
