       ...
       switch(type)
       {
           case "One month":
           {
               ...
               for(Taxes tax : all)
               {
                   ...
                   {
                       if(values.containsKey(tax.getPayment_date().get(Calendar.DAY_OF_MONTH)+tax.getPayment_date().get(Calendar.DAY_OF_MONTH) +" "+MonthName(tax.getPayment_date().get(Calendar.MONTH)+1)))
                       {
                           values.replace(tax.getPayment_date().get(Calendar.DAY_OF_MONTH)+"."
                                   +tax.getPayment_date().get(Calendar.MONTH)+1,values.get(tax.getPayment_date().get(Calendar.DAY_OF_MONTH)+"."
                                   +tax.getPayment_date().get(Calendar.MONTH)+1)+tax.getPayment_amount());

                       }else
                       {
                           values.put(tax.getPayment_date().get(Calendar.DAY_OF_MONTH) +" "+MonthName(tax.getPayment_date().get(Calendar.MONTH)+1)
